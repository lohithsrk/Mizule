...
class CreateZule : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cbfcAdapter = CBFCAdapter(cbfcTags, null)
        ...
        val genre_adapter = GenreAdapter(genres, null)
...
//TODO file ext validation, fields validation
            ...
            retService.create(
                body,
                thumbnail_16_9_filePart,
                thumbnail_9_16_filePart,
                zule_filePart,
                teaser_filePart
            ).enqueue(
                object : Callback<String> {
                    ...
                    override fun onFailure(call: Call<String>, t: Throwable) {
                        ...
                        Toast.makeText(this@CreateZule, "Something went wrong", Toast.LENGTH_LONG)
                            .show()
                    }
                }
            )
